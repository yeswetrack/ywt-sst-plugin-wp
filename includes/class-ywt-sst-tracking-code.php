...
class YWT_SST_Tracking_Code {
	...
	public function init() {
		if ( YWT_SST_FIELD_PLACEMENT_VALUE_CODE !== YWT_SST_Helpers::get_option_container_placement() ) {
			return;
		}
	...
	public function head() {
		if ( YWT_SST_Helpers::is_enable_cookie_keeper() ) {
	...
	public function body() {
		...
		<noscript><iframe src="' . esc_attr( YWT_SST_Helpers::get_gtm_container_url() ) . '/ns.html?id=' . esc_attr( YWT_SST_Helpers::get_gtm_container_id() ) . '"
	...
	private function print_default_gtm_code() {
		...
		<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
		        ...
		        '" . esc_attr( YWT_SST_Helpers::get_gtm_container_url() ) . '/' . esc_attr( YWT_SST_Helpers::get_gtm_container_identifier() ) . ".js?id='+i+dl;f.parentNode.insertBefore(j,f);
		    })(window,document,'script','dataLayer','" . esc_js( YWT_SST_Helpers::get_gtm_container_id() ) . "');</script>
	...
	private function add_cookie_keeper() {
		if ( ! YWT_SST_Helpers::is_enable_cookie_keeper() ) {
			if ( ! empty( $_COOKIE[ YWT_SST_COOKIE_KEEPER_NAME ] ) ) {
				YWT_SST_Helpers::delete_cookie( YWT_SST_COOKIE_KEEPER_NAME );
			}
			return;
		}
		...
		YWT_SST_Helpers::set_cookie(
			array(
				'name'    => YWT_SST_COOKIE_KEEPER_NAME,
